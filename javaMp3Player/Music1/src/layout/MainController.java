...
public class MainController {
	...
	public void loadList() {
		File musicFile = new File("C:\\Users\\김동현\\Desktop\\javaMp3Player\\Music1\\src\\application\\music");
	...
	public void listDropped(DragEvent event) {
		...
		if (db.hasFiles()) {
			for (File f : db.getFiles()) {
				...
				File musicFile = new File("C:\\Users\\김동현\\Desktop\\javaMp3Player\\Music1\\src\\application\\music" + f.getName());
